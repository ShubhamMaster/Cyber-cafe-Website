...
<head>
    ...
    <title> Character verification </title>
...
<hr class="hr_tag" color="black">
            ...
            <div class="input_field">
                <label for="input">Passport size photo<p class="p" style="font-size: 15px;"> (	पासपोर्ट साइज  फोटो  ) </p> </label>
          ...
          <div class="input_field">
                <label for="input">Leaving_certificate<p class="p" style="font-size: 15px;"> ( शाळा सोडल्याचा दाखला ) </p> </label>
          ...
          <div class="input_field">
                <label for="input">police clearance<p class="p" style="font-size: 15px;"> (	नोकरीसाठी अर्ज केलेल्या कंपनीचे पोलिस क्लिअरन्स सर्टिफिकेट हवे ) </p> </label>
                <input type="file" class="input"   required id="police_clearance"
