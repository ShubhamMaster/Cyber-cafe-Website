      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="assets/images/about-left-image.avif" alt="">
          </div>
        </div>
        ...
        <div class="col-lg-5">
          <div class="left-content">
            ...
            <div class="green-button">
              <a href="contact-us.php">Discover More</a>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="item">
                  <em>01</em>
                  <h4>Color Print</h4>
                  <p>All types color print's & zerox....</p>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="item">
                  <em>02</em>
                  <h4>Project Work</h4>
                  <p>Word Document, presentation, Exel Files....</p>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="item">
                  ...
                  <p>Keyboard ,mouse, mouse pad, speaker, cables,...</p>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="item">
                  <em>04</em>
                  <h4>Toner Refilling</h4>
                  <p>All printers</p>
                </div>
              </div>
            </div>
